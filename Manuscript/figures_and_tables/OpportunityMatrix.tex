...
\caption{Opportunity matrix prioritizing research direction types across analytical levels (micro routines, meso infrastructures, macro institutions, inter-organizational ecosystems). Used with Figure~\ref{fig:enactment_scope} in Section~\ref{sec:RD} to sequence theory, measurement, simulation, and governance tasks.}
